...
def fix_video_content():
    conn = sqlite3.connect('nis2_supply_chain.db')
    cursor = conn.cursor()
    
    print("=== AGGIORNAMENTO CONTENUTI VIDEO CON LINK REALI ===")
    
    # Contenuti video con link YouTube reali
    video_updates = [
        # Corso 1: Fondamenti NIS2 - Video reale su cybersecurity
        {
            'content_id': 2,
            'new_content': '''
...
<div class="video-player">
    <div class="video-container">
        <iframe src="https://www.youtube.com/embed/ZZ5LpwO-An4" 
                allowfullscreen style="width: 100%; height: 400px; border: none; border-radius: 8px;"></iframe>
    </div>
</div>
...
'''
        ...
        # Corso 2: Gestione del Rischio - Video reale su risk management
        {
            'content_id': 4,
            'new_content': '''
...
'''
        ...
        # Corso 3: Business Continuity - Video reale su business continuity
        {
            'content_id': 1,
            'new_content': '''
...
'''
    ...
    for update in video_updates:
        ...
        print(f"✅ Aggiornato contenuto ID {update['content_id']} con video reale")
    
    conn.commit()
    conn.close()
    print("✅ Contenuti video aggiornati con successo!")
    print("🎥 I video ora dovrebbero essere visibili direttamente nella pagina!")
